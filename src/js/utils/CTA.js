export default class CTA {
    ...
    createCTAText() {
        this.ctaText = this.scene.add.text(this.ctaButton.x, this.ctaButton.y, this.scene.getLocalizedText('play_now'), { fontFamily: 'mainFont', fontSize: this.scene.fontSize, color: '#FFFFFF' })
            .setOrigin(0.5)
            .setTint(0xFFFFFF)
            .setDepth(21);
        this.updateCTATextPosition();
