...
export default class MainScene extends Phaser.Scene {
    ...
    createTutorialMessage() {
        ...
        this.tutText = this.add.text(this.centerX, tutY, this.getLocalizedText('game_tut'), { fontFamily: 'speechFont', fontSize: '32px', color: '#096a55' })
            .setDepth(11)
            .setOrigin(0.5)
            .setTint(0xFFFFFF);
    ...
    handleGlobalClick() {
        ...
        if (this.gameOver && this.gamePhase > 2) {
            ...
            // transition to end module (optional)
            this.transitionEnd();
